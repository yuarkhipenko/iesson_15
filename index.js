...
var myPrint = (a, b, r) => `${a}^${b}=${r}`;
var myPow = (a, b, сb) => {
var pow = (x, n) => { 
  if(n !== 1) x *= pow(x, n - 1);
  return x;
};
return сb(a, b, pow(a, b));   
};
...
console.log(myDouble(2, 3));

console.log(myDouble(2, 4));

console.log(myDouble(2, 5));

var myTriple = myMul.bind(null, 3);

console.log(myTriple(3, 3));

console.log(myTriple(3, 4));

console.log(myTriple(3, 5));
